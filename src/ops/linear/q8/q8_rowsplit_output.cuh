...
struct Q8ContiguousOutput {
    ...
    __device__ __forceinline__ Q8OutputTile tile(std::int32_t /*parent_row_begin*/) const {
        return {data, leading_dim, 0};
    }
};

template <std::int32_t Rows0, std::int32_t Rows1>
struct Q8SplitOutput2 {
